<script>
    ...
    var temp_dataset = [<?php echo ChartOne(12); ?>, <?php echo ChartOne(11); ?>, <?php echo ChartOne(10); ?>, <?php echo ChartOne(9); ?>, <?php echo ChartOne(8); ?>, <?php echo ChartOne(7); ?>, <?php echo ChartOne(6); ?>, <?php echo ChartOne(5); ?>, <?php echo ChartOne(4); ?>, <?php echo ChartOne(3); ?>, <?php echo ChartOne(2); ?>, <?php echo ChartOne(1); ?>];
    var rain_dataset = [<?php echo ChartOnex(12); ?>, <?php echo ChartOnex(11); ?>, <?php echo ChartOnex(10); ?>, <?php echo ChartOnex(9); ?>, <?php echo ChartOnex(8); ?>, <?php echo ChartOnex(7); ?>, <?php echo ChartOnex(6); ?>, <?php echo ChartOnex(5); ?>, <?php echo ChartOnex(4); ?>, <?php echo ChartOnex(3); ?>, <?php echo ChartOnex(2); ?>, <?php echo ChartOnex(1); ?>];
    ...
    var myBar = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                    ...
                    data: [1, 20, 30, 22, 17, 10, 18, 26, 28, 26, 20, 32],
                }, {
                    label: 'Plan Purchage',
