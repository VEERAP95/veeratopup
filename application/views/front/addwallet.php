...
$currency = "USD";
$productPrice = $this->input->post('amount');
	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
		  <div class="modal-header">
			<h5 class="modal-title" id="exampleModalLabel">Add Wallet $<?php echo $productPrice; ?></h5>
...
paypal.Button.render({
  ...
  onAuthorize: function (data, actions) {
	return actions.payment.execute()
	  .then(function () {
		window.location = "<?php echo base_url('paypal'); ?>?paymentID="+data.paymentID+"&a=<?php echo $productPrice; ?>&e=<?php echo $email; ?>&item_name=Add Wallet";
	  });
  }
}, '#paypal-button');
</script>
