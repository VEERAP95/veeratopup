...
<body class="">
    ...
    <section class="padding-top-30">
        <div class="container">
            ...
            <div id="pnlsignupbox" class="mainbox">
                <div class="login-box">
                
                    <div class="login-logo">
                        <a href="<?php echo base_url() ?>home"><img width="300" src="<?php echo base_url() ?>assets/Content/img/Company-logo.png" alt="Send mobile recharge worldwide"> </a>
                    </div>
                    <div class="login-box-body">
                        <h3 class="text-center margin-top-15">
                            Sign Up
                        </h3>
                        <p class="text-center"> Already a member?  <a href="login">Login</a> </p>
                        <!-- <p class="text-center text-red">
                            Enter exact legal first and last names, email address, mobile number as per your Bank card details to avoid payment cancelation.
                        </p> -->
                        <hr>
                        <?php
...
<form action="<?php echo base_url() ?>auth/register" method="post">
                                <div id="PnlMobileNumberVerification">
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <span class="select-box-arrow-lg">
                                                <select class="form-control input-lg" data-val="true" data-val-required="The CountryID field is required." id="ddlDialCodePhoneOTP" name="CountryID"><option data-countryCode="DZ" value="213">Algeria (+213)</option>
		...
		<option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control input-lg text-box single-line" data-val="true" data-val-required="Enter mobile number" id="txtSignUpMobileNo" name="MobileNo" placeholder="Mobile" type="number" value="">
                                            <span class="field-validation-valid error-msg" data-valmsg-for="MobileNo" data-valmsg-replace="true"></span>
                                ...
                                <div class="row">
                                    <div class="col-sm-7 col-xs-7 padding-right-0">
                                        <div class="form-group">
                                            <input class="form-control input-lg text-box single-line" data-val="true" data-val-required="Enter first name" id="txtSignUpFirstName" name="FirstName" placeholder="First name" type="text" value="">
                                            <span class="field-validation-valid error-msg" data-valmsg-for="FirstName" data-valmsg-replace="true"></span>
                                        </div>
                                    </div>

                                    <div class="col-sm-5 col-xs-5 padding-left-0">
                                        <div class="form-group">
                                            <input class="form-control input-lg text-box single-line" data-val="true" data-val-required="Enter last name" id="txtSignUpLastName" name="LastName" placeholder="Last name" type="text" value="">
                                ...
                                <div class="form-group">
                                    <input class="form-control input-lg text-box single-line" data-val="true" data-val-regex="Invalid Email Adddress" data-val-regex-pattern="^[a-z0-9_\+-]+(\.[a-z0-9_\+-]+)*@[a-z0-9-]+(\.[a-z0-9]+)*\.([a-z]{2,4})$" data-val-required="Enter email" id="txtMobile" name="Email" placeholder="Email" type="email" value="">
                                    <span class="field-validation-valid error-msg" data-valmsg-for="Email" data-valmsg-replace="true"></span>
                                    <span id="TxtMobileerrormsg" class="error-msg"></span>
                                </div>
                                ...
                                <div class="form-group">
                                    <input class="form-control input-lg text-box single-line password" data-val="true" data-val-regex="Minimum 6 characters, at least one number, one uppercase letter" data-val-regex-pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{6,}$" data-val-required="Enter password" id="txtSignUpPassword" name="Password" placeholder="Password" type="password" value="">
                                    <span class="field-validation-valid error-msg" data-valmsg-for="Password" data-valmsg-replace="true"></span>

                                </div>
                                <div class="form-group">
                                    <input class="form-control input-lg text-box single-line password" data-val="true" data-val-equalto="Passwords don&#39;t match." data-val-equalto-other="*.Password" data-val-required="Re-enter password" id="txtSignUpConfirmPassword" name="ConfirmPassword" placeholder="Confirm password" type="password" value="">
                                    <span class="field-validation-valid error-msg" data-valmsg-for="ConfirmPassword" data-valmsg-replace="true"></span>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 text-center">
                                        <p class="small"> By clicking Sign up, you accept our <a href="term-conditions" target="_blank">Terms & Conditions</a>  and <a href="privacy-policy" target="_blank">Privacy Policy</a></p>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <input class="btn btn-theme btn-shadow btn-curved btn-block btn-lg" type="submit" name="submit" value="Sign Up">
                                        <label id="lblerror" class="bg-danger"></label>
                                    </div>
